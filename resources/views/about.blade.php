...
<body>
        ...
        <div class="row gy-4">
            ...
            <div class="portfolio-details-slider swiper">
              <div class="swiper-wrapper align-items-center">
                ...
                <div class="swiper-slide">
                  <img src="{{asset('MyResume')}}/assets/img/portfolio/portfolio-details-1.jpg" alt="">
                </div>

                <div class="swiper-slide">
                  <img src="{{asset('MyResume')}}/assets/img/portfolio/portfolio-details-2.jpg" alt="">
                </div>

                <div class="swiper-slide">
                  <img src="{{asset('MyResume')}}/assets/img/portfolio/20200824_193804.png" alt="">
                </div>
          ...
          <div class="col-lg-4">
            <div class="portfolio-info">
              ...
              <ul>
                <li><strong>Nama</strong>: Noorman Putra Ksatria</li>
                <li><strong>NPM</strong>: 19552011120</li>
                <li><strong>Kelas</strong>: TIF RM 18 CID</li>
                <li><strong>Kontak</strong>: <a href="#">https://www.instagram.com/nnrrmmnn_/</a></li>
              </ul>
            </div>
            <div class="portfolio-description">
              <h2>Alteon Books</h2>
              <p>
                Alteon Books merupakan sistem piminjaman buku perspustakaan secara online, Sistem Alteon books ini masih jauh dari kata sempurna
              </p>
            </div>
          </div>
  ...
  <!-- Vendor JS Files -->
  <script src="{{asset('MyResume')}}/assets/vendor/purecounter/purecounter.js"></script>
